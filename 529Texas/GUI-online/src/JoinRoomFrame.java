...
public class JoinRoomFrame extends JFrame implements MouseListener {
	...
	public JoinRoomFrame(String token, String roomId, HallUI parent) {
...
//事件区域
	...
	public void mousePressed(MouseEvent e) {// 点击后
		if (e.getSource() == small_mig) {
			...
			System.out.println("JoinRoomFrame: passWord is" + passWord);
			...
			TexasHttpUtils.updateByJEvent(res, JoinRoomFrame.this.parent);
			dispose();
