...
public class TexasPokerFrame  {
	...
	public static void main(final String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					final TexasPokerFrame window = new TexasPokerFrame("" , null, null);
	 ...
	 */
	public TexasPokerFrame(String token, IHallController hallController, HallUI parent) {
		this.token = token;
		...
		*/
		...
		frame.addWindowListener(new java.awt.event.WindowAdapter() {
			...
			public void windowClosing(java.awt.event.WindowEvent windowEvent) {
				try {
					hallController.handler_exit_room(token);	
					frame.dispose();
					Naming.unbind("//localhost:12211/TexasGameGUI");
